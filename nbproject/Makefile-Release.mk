...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tgen: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tgen ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CScaffold.o: CScaffold.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CScaffold.o CScaffold.cpp

${OBJECTDIR}/CSystem.o: CSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSystem.o CSystem.cpp
